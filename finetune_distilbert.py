...
def main():
	...
	model = DistilBertForMaskedLM.from_pretrained("sbnation_distilbert")
	tokenizer = DistilBertTokenizer.from_pretrained("sbnation_distilbert")
	...
	config = DistilBertConfig.from_pretrained("sbnation_distilbert")
